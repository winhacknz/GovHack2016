...
gulp.task("clean.all", ["clean.libs", "clean.app", "clean.html"]);
...
gulp.task("delete.scripts", function () {
    ...
    var watcher = gulp.watch("scripts/**/*.+(ts|js|html)", ["ts", "js", "html"]);
...
gulp.task("watch",
    ["watch.ts", "watch.less", "watch.css", "watch.html", "watch.js", "delete.scripts", "delete.styles"]);

gulp.task("build",
    function (callback) {
        runSeq("libs", ["fonts", "images", "less", "css", "ts", "js", "html", "index"], callback);
    });
